                    ...
                    <div className="signupFrame">
                        <div className="boxSignup">
                            ...
                            <form onSubmit={this.handleSubmit} >
                                ...
                                <br/>
                                <h5>When you log in next time and in order to complete your subscription and offer your service(s) you will be asked to pay a monthly fee of $20,000 which covers the use of our platform.</h5>
                                <br />
